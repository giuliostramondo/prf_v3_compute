...
#define MEMORYCONTROLLER_COMMAND_ECHO_STREAM_NAME(name) name
...
// internal stuff
#define INTERNAL_MEMORYCONTROLLER_CONTROL_STREAM_NAME(number) std::string("CTRL_") + std::to_string(number)
#define INTERNAL_MEMORYCONTROLLER_COMMAND_ECHO_STREAM_NAME(number) std::string("ECHO_") + std::to_string(number)
#define INTERNAL_MEMORYCONTROLLER_INPUT_STREAM_NAME(grp_name,number) std::string("INPUT_") + grp_name + std::string("_") + std::to_string(number)
#define INTERNAL_MEMORYCONTROLLER_OUTPUT_STREAM_NAME(grp_name,number) std::string("OUTPUT_") + grp_name + std::string("_") + std::to_string(number)
