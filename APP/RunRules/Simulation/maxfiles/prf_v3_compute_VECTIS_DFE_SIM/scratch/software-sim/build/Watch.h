...
{
private:
	typedef std::map<t_port_number, std::shared_ptr<DataWriter> > WriterMap; // needs to be ordered!
	typedef std::list<std::pair<t_port_number, Data> > ValueList;
	typedef std::map<t_port_number, Data> ValueMap;
	typedef std::map<t_port_number, std::shared_ptr<std::ofstream> > StreamMap;
...
public:
	...
	t_port_number addInput(const std::string &name, const std::string &unmangled_name, std::shared_ptr<DataWriter> writer);
	t_port_number addConstant(const std::string &name, const std::string &unmangled_name, std::shared_ptr<DataWriter> writer, const Data &data);
