...
private:
	...
	typedef std::unordered_map<std::string, MappedRegisterPtr> t_mapped_reg_map;
	t_mapped_reg_map m_mapped_reg_map;
	typedef std::unordered_map<std::string, AbstractMappedMemoryPtr> t_mapped_mem_map;
	t_mapped_mem_map m_mapped_mem_map;

	typedef std::unordered_map<std::string, IOClass> t_io_class_map;
