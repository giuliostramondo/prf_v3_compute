...
public:
	MappedElement() : m_observers(), m_address(~0U) {}
...
typedef std::shared_ptr<MappedElement> MappedElementPtr;
...
typedef std::shared_ptr<MappedRegister> MappedRegisterPtr;
...
typedef std::shared_ptr<AbstractMappedMemory> AbstractMappedMemoryPtr;
...
typedef std::shared_ptr<MappedMemory> MappedMemoryPtr;
