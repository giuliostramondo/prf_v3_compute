...
protected:
	...
	typedef std::shared_ptr<PushConnection> PushConnectionPtr;
...
public:
	...
	void connectPushOutput(const std::string &output_name,
		PushSinkSync &dst, const std::string &dst_input_id);
	void connectPushOutput(t_port_number local_port,
